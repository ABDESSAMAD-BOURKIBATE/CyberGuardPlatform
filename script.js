...
const toolExplanations = {
    ar: {
        passwordStrength: {
            title: "محلل قوة كلمة المرور المتقدم",
            ...
            content: `
                <div class="explanation-section">
                    ...
                    <p>محلل قوة كلمة المرور هو أداة تحليل أمني متقدمة تستخدم خوارزميات متطورة لتقييم مستوى الأمان في كلمات المرور ومقاومتها للهجمات السيبرانية المختلفة بما في ذلك الهجمات بالقوة الغاشمة وهجمات القاموس والهندسة الاجتماعية.</p>
                </div>
                
                <div class="tool-metrics">
                    <div class="metric-card">
                        <div class="metric-title">معايير التحليل</div>
                        <div class="metric-value">15+</div>
                        <div class="metric-description">عامل أمان مختلف</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">دقة التقييم</div>
                        <div class="metric-value">99.9%</div>
                        <div class="metric-description">معدل الدقة</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">سرعة المعالجة</div>
                        <div class="metric-value">< 1ms</div>
                        <div class="metric-description">زمن الاستجابة</div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>⚙️ آلية العمل المتقدمة</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">🔢</div>
                            <div class="feature-title">تحليل التعقيد الرقمي</div>
                            <div class="feature-description">فحص طول كلمة المرور ومستوى التنوع في الأحرف والأرقام والرموز</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#e74c3c">
                                    ...
                                    <path d="M12 2v4M12 18v4M22 12h-4M6 12H2" stroke="#2c3e50" stroke-width="1"/>
                                </svg>
                            </div>
                            <div class="feature-title">كشف الأنماط المتكررة</div>
                            <div class="feature-description">اكتشاف الأنماط التسلسلية والتكرارات التي تضعف الأمان</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🛡️</div>
                            <div class="feature-title">مقاومة الهجمات</div>
                            <div class="feature-description">تقييم القدرة على مقاومة هجمات القوة الغاشمة والقاموس</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">⏱️</div>
                            <div class="feature-title">حساب زمن الكسر</div>
                            <div class="feature-description">تقدير الوقت المطلوب لكسر كلمة المرور بأحدث التقنيات</div>
                        </div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>📊 مستويات التقييم الشامل</h4>
                    <ul>
                        <li><strong>ضعيف جداً (0-20%):</strong> أقل من 8 أحرف، أنماط بسيطة، يمكن كسرها في ثوانٍ</li>
                        <li><strong>ضعيف (21-40%):</strong> 8-10 أحرف بتنوع محدود، مقاومة ضعيفة للهجمات</li>
                        <li><strong>متوسط (41-60%):</strong> 11-14 حرف مع بعض التعقيد، حماية معقولة</li>
                        <li><strong>قوي (61-80%):</strong> 15+ حرف مع تنوع جيد، مقاومة عالية للهجمات</li>
                        <li><strong>قوي جداً (81-100%):</strong> 20+ حرف مع تعقيد عالي، حماية متقدمة</li>
                    </ul>
                </div>
                
                <div class="warning-section">
                    <h4>تحذيرات أمنية مهمة</h4>
                    <p>تجنب استخدام المعلومات الشخصية مثل تواريخ الميلاد أو أسماء الأقارب أو كلمات القاموس الشائعة. كلمات المرور الضعيفة هي السبب الرئيسي في 81% من انتهاكات البيانات.</p>
                </div>
                
                <div class="usage-examples">
                    <h5>🎯 أفضل الممارسات الأمنية:</h5>
                    <div class="code-example">
✅ استخدم 16+ حرف على الأقل للحسابات المهمة
✅ امزج الأحرف الكبيرة والصغيرة (A-Z, a-z)
✅ أضف أرقام ورموز خاصة (!@#$%^&*()_+-=)
✅ تجنب المعلومات الشخصية تماماً
✅ استخدم عبارات مفيدة مع تعديلات ذكية
✅ غيّر كلمات المرور كل 3-6 أشهر
✅ استخدم مدير كلمات مرور احترافي
✅ فعّل المصادقة الثنائية دائماً

مثال قوي: "My$3cur3P@ssw0rd2024!"
مثال ضعيف: "password123" أو "احمد1990"
                    </div>
                </div>
            `
        },
        entropyCalculator: {
            title: "حاسبة إنتروبيا كلمة المرور المتقدمة",
            ...
            content: `
                <div class="explanation-section">
                    <h4>🧮 ما هي الإنتروبيا في الأمان السيبراني؟</h4>
                    <p>إنتروبيا كلمة المرور هي مقياس رياضي دقيق يحدد مستوى العشوائية والتعقيد والتنبؤ في كلمة المرور، وتُقاس بوحدة البت (bits). كلما زادت الإنتروبيا، زادت قوة كلمة المرور وصعوبة كسرها حتى بأقوى أجهزة الحاسوب.</p>
                </div>
                
                <div class="tool-metrics">
                    <div class="metric-card">
                        <div class="metric-title">دقة الحساب</div>
                        <div class="metric-value">100%</div>
                        <div class="metric-description">معادلات رياضية دقيقة</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">مجموعات الأحرف</div>
                        <div class="metric-value">4</div>
                        <div class="metric-description">نوع مختلف من الأحرف</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">المعيار الذهبي</div>
                        <div class="metric-value">128</div>
                        <div class="metric-description">بت للحماية القصوى</div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>🔬 طريقة الحساب العلمية</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">🎯</div>
                            <div class="feature-title">تحديد مجموعة الأحرف</div>
                            <div class="feature-description">حساب إجمالي الأحرف المتاحة (صغيرة، كبيرة، أرقام، رموز)</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">📐</div>
                            <div class="feature-title">تطبيق المعادلة</div>
                            <div class="feature-description">الإنتروبيا = log₂(حجم المجموعة) × طول كلمة المرور</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#f1c40f">
                                    <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" fill="#f39c12"/>
                                    <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" stroke="#e67e22" stroke-width="1" fill="none"/>
                                </svg>
                            </div>
                            <div class="feature-title">حساب قوة الحوسبة</div>
                            <div class="feature-description">تقدير عدد المحاولات المطلوبة لكسر كلمة المرور</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🕐</div>
                            <div class="feature-title">تقدير الزمن</div>
                            <div class="feature-description">حساب الوقت المطلوب بناءً على سرعة الحاسوب</div>
                        </div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>📊 مستويات الأمان بالبت</h4>
                    <ul>
                        <li><strong>أقل من 30 بت:</strong> خطر شديد - يمكن كسرها فوراً بأي جهاز حاسوب</li>
                        <li><strong>30-50 بت:</strong> ضعيف جداً - تُكسر في دقائق بحاسوب شخصي</li>
                        <li><strong>50-70 بت:</strong> ضعيف - تحتاج ساعات إلى أيام للكسر</li>
                        <li><strong>70-90 بت:</strong> متوسط - حماية معقولة لعدة أشهر</li>
                        <li><strong>90-110 بت:</strong> قوي - حماية جيدة لسنوات</li>
                        <li><strong>110+ بت:</strong> قوي جداً - حماية لعقود من الزمن</li>
                        <li><strong>128+ بت:</strong> المعيار الذهبي - حماية عسكرية</li>
                    </ul>
                </div>
                
                <div class="explanation-section">
                    <h4>🧑‍🔬 حجم مجموعات الأحرف</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">🔤</div>
                            <div class="feature-title">أحرف صغيرة</div>
                            <div class="feature-description">a-z = 26 حرف</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔠</div>
                            <div class="feature-title">أحرف كبيرة</div>
                            <div class="feature-description">A-Z = 26 حرف</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔢</div>
                            <div class="feature-title">أرقام</div>
                            <div class="feature-description">0-9 = 10 أرقام</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔣</div>
                            <div class="feature-title">رموز خاصة</div>
                            <div class="feature-description">!@#$%^&* = 32 رمز</div>
                        </div>
                    </div>
                </div>
                
                <div class="warning-section">
                    <h4>معايير الأمان الحديثة</h4>
                    <p>وفقاً لمعايير NIST الأمريكية و ISO 27001، الحد الأدنى المقبول للإنتروبيا هو 80 بت للحسابات العادية و 128 بت للحسابات عالية الأمان. الإنتروبيا المنخفضة تعني إمكانية التنبؤ العالية وسهولة الكسر.</p>
                </div>
                
                <div class="usage-examples">
                    <h5>🎯 أمثلة عملية على الحساب:</h5>
                    <div class="code-example">
💡 مثال 1 - كلمة مرور ضعيفة:
كلمة المرور: "password" (8 أحرف)
نوع الأحرف: أحرف صغيرة فقط (26)
الحساب: log₂(26) × 8 = 4.7 × 8 = 37.6 بت
النتيجة: ضعيف جداً - يُكسر في ثوانٍ

💪 مثال 2 - كلمة مرور قوية:
كلمة المرور: "My$3cur3P@ssw0rd!" (16 حرف)
نوع الأحرف: جميع الأنواع (94)
الحساب: log₂(94) × 16 = 6.55 × 16 = 104.8 بت
النتيجة: قوي جداً - يحتاج مليارات السنين

🔢 مثال 3 - كلمة مرور متوسطة:
كلمة المرور: "Ahmed123" (8 أحرف)
نوع الأحرف: أحرف وأرقام (62)
الحساب: log₂(62) × 8 = 5.95 × 8 = 47.6 بت
النتيجة: ضعيف - يُكسر في دقائق
                    </div>
                </div>
            `
        },
        passwordGenerator: {
            title: "مولد كلمات المرور الاحترافي المتقدم",
            ...
            content: `
                <div class="explanation-section">
                    <h4>🔐 ما هو مولد كلمات المرور الاحترافي؟</h4>
                    <p>أداة أمان متقدمة تستخدم خوارزميات التشفير العشوائي الحقيقي (True Random) والذكاء الاصطناعي لإنتاج كلمات مرور قوية ومعقدة وغير قابلة للتنبؤ، مع ضمان أقصى درجات الحماية ضد جميع أنواع الهجمات السيبرانية المعروفة.</p>
                </div>
                
                <div class="tool-metrics">
                    <div class="metric-card">
                        <div class="metric-title">مستوى العشوائية</div>
                        <div class="metric-value">100%</div>
                        <div class="metric-description">Crypto API معتمد</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">طول قابل للتخصيص</div>
                        <div class="metric-value">8-128</div>
                        <div class="metric-description">حرف قابل للتعديل</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">إنتروبيا قصوى</div>
                        <div class="metric-value">850+</div>
                        <div class="metric-description">بت للحماية المطلقة</div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>🛡️ التقنيات المتقدمة المستخدمة</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#9b59b6">
                                    <rect x="3" y="3" width="18" height="18" rx="2" ry="2" fill="#8e44ad"/>
                            ...
                            <div class="feature-title">Cryptographically Secure RNG</div>
                            <div class="feature-description">مولد أرقام عشوائية آمن تشفيرياً باستخدام Web Crypto API</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔀</div>
                            <div class="feature-title">خوارزمية التوزيع المتوازن</div>
                            <div class="feature-description">ضمان التوزيع العادل لجميع أنواع الأحرف والرموز</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🚫</div>
                            <div class="feature-title">منع الأنماط المتكررة</div>
                            <div class="feature-description">كشف ومنع التسلسلات والتكرارات الضارة بالأمان</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">⚡</div>
                            <div class="feature-title">التقييم الفوري</div>
                            <div class="feature-description">تحليل فوري لقوة كلمة المرور المولدة وإنتروبيتها</div>
                        </div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>📚 مجموعات الأحرف المتاحة</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">🔤</div>
                            <div class="feature-title">أحرف صغيرة</div>
                            <div class="feature-description">a-z (26 حرف) - الأساس اللغوي</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔠</div>
                            <div class="feature-title">أحرف كبيرة</div>
                            <div class="feature-description">A-Z (26 حرف) - تضاعف التعقيد</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔢</div>
                            <div class="feature-title">أرقام</div>
                            <div class="feature-description">0-9 (10 أرقام) - قوة حسابية</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔣</div>
                            <div class="feature-title">رموز خاصة</div>
                            <div class="feature-description">32 رمز متنوع - حماية قصوى</div>
                        </div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>🎯 استراتيجيات الأمان المتقدمة</h4>
                    <ul>
                        <li><strong>التوزيع الإحصائي:</strong> ضمان التوزيع العشوائي الحقيقي للأحرف</li>
                        <li><strong>فحص القوة التلقائي:</strong> تقييم فوري وتحسين كلمة المرور</li>
                        <li><strong>منع التصادمات:</strong> ضمان عدم تكرار كلمات المرور</li>
                        <li><strong>التشفير الآمن:</strong> استخدام أحدث معايير التشفير</li>
                        <li><strong>الامتثال للمعايير:</strong> متوافق مع NIST و ISO 27001</li>
                    </ul>
                </div>
                
                <div class="warning-section">
                    <h4>معايير الأمان الاحترافية</h4>
                    <p>وفقاً لأحدث توصيات الأمان السيبراني، يُنصح بشدة باستخدام كلمات مرور بطول 16 حرف كحد أدنى للحسابات الشخصية و 20+ حرف للحسابات المؤسسية. كلمات المرور القصيرة تُعتبر خطراً أمنياً حتى لو كانت معقدة.</p>
                </div>
                
                <div class="usage-examples">
                    <h5>🏆 أفضل الممارسات الاحترافية:</h5>
                    <div class="code-example">
🎯 للحسابات الشخصية:
✅ طول 16-20 حرف كحد أدنى
✅ تفعيل جميع أنواع الأحرف والرموز
✅ كلمة مرور فريدة لكل حساب
✅ تحديث كل 3-6 أشهر

🏢 للحسابات المؤسسية:
✅ طول 24+ حرف للحسابات الإدارية
✅ كلمة مرور مختلفة للحسابات المهمة
✅ استخدام مدير كلمات مرور احترافي
✅ المصادقة متعددة العوامل (MFA) إجبارية

🔐 نصائح الحفظ والإدارة:
✅ استخدم مدير كلمات مرور معتمد
✅ لا تحفظ كلمات المرور في الملاحظات
✅ لا تشارك كلمات المرور عبر البريد الإلكتروني
✅ راجع كلمات المرور دورياً

⚠️ أمثلة على القوة:
قوة منخفضة: 8 أحرف = 38 بت
قوة متوسطة: 12 حرف = 78 بت  
قوة عالية: 16 حرف = 104 بت
قوة قصوى: 24 حرف = 156 بت
                    </div>
                </div>
            `
        },
        leakChecker: {
            title: "فاحص تسريب كلمات المرور المتقدم",
            icon: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h3l-4 4-4-4h3V7z",
            content: `
                <div class="explanation-section">
                    <h4>🔍 ما هو فاحص التسريب المتقدم؟</h4>
                    <p>أداة أمان حيوية تتحقق من وجود كلمة المرور في قواعد بيانات التسريبات العالمية المعروفة والمتاحة للمجرمين السيبرانيين، مما يساعد في تحديد ما إذا كانت كلمة المرور معرضة للخطر أو مكشوفة في الأسواق السوداء للويب المظلم.</p>
                </div>
                
                <div class="tool-metrics">
                    <div class="metric-card">
                        <div class="metric-title">قواعد البيانات</div>
                        <div class="metric-value">50+</div>
                        <div class="metric-description">مليار كلمة مرور مسربة</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">معدل التحديث</div>
                        <div class="metric-value">يومي</div>
                        <div class="metric-description">قواعد بيانات محدثة</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">مستوى الخصوصية</div>
                        <div class="metric-value">100%</div>
                        <div class="metric-description">لا تُحفظ كلمات المرور</div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>🛡️ آلية الفحص الآمنة</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#00ff88">
                                    <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/>
                                </svg>
                            </div>
                            <div class="feature-title">تشفير SHA-256</div>
                            <div class="feature-description">تحويل كلمة المرور إلى hash آمن قبل الفحص</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🌐</div>
                            <div class="feature-title">API آمنة</div>
                            <div class="feature-description">استخدام بروتوكولات HTTPS آمنة للاستعلام</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#ff4757">
                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zM4 12c0-4.42 3.58-8 8-8 1.85 0 3.55.63 4.9 1.69L5.69 16.9C4.63 15.55 4 13.85 4 12zm8 8c-1.85 0-3.55-.63-4.9-1.69L18.31 7.1C19.37 8.45 20 10.15 20 12c0 4.42-3.58 8-8 8z"/>
                                </svg>
                            </div>
                            <div class="feature-title">عدم التخزين</div>
                            <div class="feature-description">لا يتم حفظ أو تسجيل كلمات المرور نهائياً</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">⚡</div>
                            <div class="feature-title">فحص فوري</div>
                            <div class="feature-description">نتائج سريعة خلال ثوانٍ معدودة</div>
                        </div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>📊 مصادر البيانات المراقبة</h4>
                    <ul>
                        <li><strong>تسريبات الشركات الكبرى:</strong> فيسبوك، ياهو، ليندكدإن، أدوبي</li>
                        <li><strong>المنتديات والمواقع:</strong> تسريبات المنتديات ومواقع التسوق</li>
                        <li><strong>قواعد بيانات الهاكرز:</strong> مجموعات كلمات المرور المسربة</li>
                        <li><strong>الويب المظلم:</strong> الأسواق السوداء لبيع البيانات</li>
                        <li><strong>برمجيات الفدية:</strong> بيانات مسربة من هجمات الفدية</li>
                        <li><strong>التصيد الإلكتروني:</strong> حملات التصيد الناجحة</li>
                    </ul>
                </div>
                
                <div class="explanation-section">
                    <h4>🚨 مؤشرات الخطر والتحذيرات</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">🟢</div>
                            <div class="feature-title">آمن</div>
                            <div class="feature-description">لم يتم العثور على كلمة المرور في التسريبات</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🟡</div>
                            <div class="feature-title">تحذير</div>
                            <div class="feature-description">كلمة مرور مشابهة موجودة في التسريبات</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🟠</div>
                            <div class="feature-title">خطر متوسط</div>
                            <div class="feature-description">كلمة المرور موجودة في تسريبات قديمة</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔴</div>
                            <div class="feature-title">خطر شديد</div>
                            <div class="feature-description">كلمة المرور موجودة في تسريبات حديثة</div>
                        </div>
                    </div>
                </div>
                
                <div class="warning-section">
                    <h4>إحصائيات مخيفة عن التسريبات</h4>
                    <p>أكثر من 15 مليار كلمة مرور مكشوفة في التسريبات العامة! 65% من الناس يعيدون استخدام نفس كلمة المرور في حسابات متعددة، مما يعني أن تسريب واحد يمكن أن يعرض جميع حساباتهم للخطر.</p>
                </div>
                
                <div class="usage-examples">
                    <h5>🛡️ خطة العمل عند اكتشاف التسريب:</h5>
                    <div class="code-example">
🚨 إذا كانت كلمة المرور مسربة - اتخذ إجراءً فورياً:

1️⃣ غيّر كلمة المرور فوراً في جميع الحسابات
2️⃣ فعّل المصادقة الثنائية (2FA) في جميع الحسابات
3️⃣ راجع نشاط الحساب للتأكد من عدم الاختراق
4️⃣ أنشئ كلمة مرور جديدة قوية وفريدة
5️⃣ استخدم مدير كلمات مرور احترافي
6️⃣ راقب حساباتك المصرفية والمالية
7️⃣ أبلغ عن أي نشاط مشبوه فوراً

🔍 للفحص الدوري:
✅ افحص كلمات المرور شهرياً
✅ اشترك في تنبيهات التسريب
✅ راقب التقارير الأمنية
✅ حدّث كلمات المرور دورياً

⚠️ علامات الاختراق المحتمل:
🚩 رسائل تسجيل دخول مجهولة
🚩 تغييرات في إعدادات الحساب
🚩 عمليات شراء أو معاملات غريبة
🚩 رسائل تحذيرية من الخدمات
                    </div>
                </div>
            `
        },
        leakChecker: {
            title: "فاحص التسريبات المتقدم",
            icon: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-13h2v6h3l-4 4-4-4h3V7z",
            content: `
                <div class="explanation-section">
                    <h4>كيف تعمل؟</h4>
        ...
        hashGenerator: {
            title: "مولد الهاش التشفيري المتقدم",
            icon: "M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z",
            content: `
                <div class="explanation-section">
                    <h4>🔐 ما هو مولد الهاش التشفيري؟</h4>
                    <p>أداة تشفير احترافية تحول النصوص والبيانات إلى قيم هاش مشفرة فريدة باستخدام خوارزميات التشفير العالمية المعتمدة، مما يضمن سلامة البيانات والحماية من التلاعب والتزوير في النظم الرقمية الحديثة.</p>
                </div>
                
                <div class="tool-metrics">
                    <div class="metric-card">
                        <div class="metric-title">خوارزميات مدعومة</div>
                        <div class="metric-value">8+</div>
                        <div class="metric-description">خوارزمية تشفير متقدمة</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">سرعة المعالجة</div>
                        <div class="metric-value">&lt; 0.1ms</div>
                        <div class="metric-description">زمن استجابة فوري</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">دقة التشفير</div>
                        <div class="metric-value">100%</div>
                        <div class="metric-description">ضمان عدم التصادم</div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>🧮 خوارزميات التشفير المتاحة</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">🟠</div>
                            <div class="feature-title">MD5 (128-bit)</div>
                            <div class="feature-description">سريع جداً، مناسب للتحقق السريع، لكن أقل أماناً للتطبيقات الحساسة</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🟡</div>
                            <div class="feature-title">SHA-1 (160-bit)</div>
                            <div class="feature-description">متوسط الأمان، مستخدم في Git وبعض البروتوكولات القديمة</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🟢</div>
                            <div class="feature-title">SHA-256 (256-bit)</div>
                            <div class="feature-description">معيار الأمان الحديث، مستخدم في Bitcoin والتطبيقات الحساسة</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔵</div>
                            <div class="feature-title">SHA-512 (512-bit)</div>
                            <div class="feature-description">أقصى درجات الأمان، مناسب للتطبيقات العسكرية والحكومية</div>
                        </div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>🎯 الاستخدامات العملية المتقدمة</h4>
                    <ul>
                        <li><strong>التحقق من سلامة البيانات:</strong> اكتشاف التعديلات والفساد في الملفات</li>
                        <li><strong>تخزين كلمات المرور الآمن:</strong> حماية كلمات المرور في قواعد البيانات</li>
                        <li><strong>التوقيعات الرقمية:</strong> تأكيد أصالة المستندات والمعاملات</li>
                        <li><strong>تقنية Blockchain:</strong> أساس العملات المشفرة وسلاسل الكتل</li>
                        <li><strong>بروتوكولات الأمان:</strong> HTTPS، TLS، SSL</li>
                        <li><strong>الطب الشرعي الرقمي:</strong> تحليل الأدلة الرقمية</li>
                        <li><strong>أنظمة إدارة الإصدارات:</strong> Git، SVN</li>
                    </ul>
                </div>
                
                <div class="explanation-section">
                    <h4>⚙️ خصائص الهاش المتقدمة</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">🎯</div>
                            <div class="feature-title">الحتمية</div>
                            <div class="feature-description">نفس المدخل ينتج دائماً نفس الهاش</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">⚡</div>
                            <div class="feature-title">السرعة</div>
                            <div class="feature-description">حساب سريع حتى للبيانات الكبيرة</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔒</div>
                            <div class="feature-title">عدم القابلية للعكس</div>
                            <div class="feature-description">مستحيل استرجاع المدخل من الهاش</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🎲</div>
                            <div class="feature-title">تأثير الانهيار</div>
                            <div class="feature-description">تغيير صغير ينتج هاش مختلف تماماً</div>
                        </div>
                    </div>
                </div>
                
                <div class="warning-section">
                    <h4>اختيار الخوارزمية المناسبة</h4>
                    <p>MD5 و SHA-1 لم تعودا آمنين للاستخدامات الحساسة بسبب اكتشاف ثغرات تصادم. استخدم SHA-256 أو أحدث للتطبيقات الأمنية الحديثة. SHA-512 مطلوب للتطبيقات عالية الأمان.</p>
                </div>
                
                <div class="usage-examples">
                    <h5>🔬 أمثلة عملية على التشفير:</h5>
                    <div class="code-example">
🔤 النص الأصلي: "CyberGuard2024"

📝 MD5:
Input: "CyberGuard2024"
...
⚠️ تأثير الانهيار:
Input: "CyberGuard2025" (تغيير رقم واحد)
SHA-256: b109f3bbbc244eb82441917ed06d618b9008dd09b3befd1b5e07394c706a8bb9
(مختلف تماماً!)

🎯 استخدامات عملية:
✅ التحقق من تكامل التنزيلات
✅ مقارنة الملفات بدون فتحها
✅ حماية كلمات المرور في قواعد البيانات
✅ إنشاء توقيعات رقمية آمنة
        ...
        portScanner: {
            title: "ماسح المنافذ الاحترافي",
            icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
            content: `
                <div class="explanation-section">
                    <h4>🔍 ما هو ماسح المنافذ؟</h4>
                    <p>أداة أمان شبكي متقدمة تقوم بفحص وتحليل المنافذ المفتوحة في الأنظمة والشبكات لاكتشاف نقاط الضعف المحتملة والخدمات النشطة، مما يساعد في تقييم الوضع الأمني وحماية البنية التحتية الرقمية من التهديدات السيبرانية.</p>
                </div>
                
                <div class="tool-metrics">
                    <div class="metric-card">
                        <div class="metric-title">نطاق المنافذ</div>
                        <div class="metric-value">1-65535</div>
                        <div class="metric-description">فحص شامل لجميع المنافذ</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">سرعة الفحص</div>
                        <div class="metric-value">1000</div>
                        <div class="metric-description">منفذ/ثانية</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">دقة الكشف</div>
                        <div class="metric-value">99.9%</div>
                        <div class="metric-description">موثوقية عالية</div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>🛡️ تقنيات الفحص المتقدمة</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">🎯</div>
                            <div class="feature-title">TCP Connect Scan</div>
                            <div class="feature-description">فحص كامل للاتصال TCP، دقيق لكن قابل للكشف</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">👤</div>
                            <div class="feature-title">SYN Stealth Scan</div>
                            <div class="feature-description">فحص خفي باستخدام SYN packets، صعب الكشف</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#3742fa">
                                    <path d="M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z"/>
                                </svg>
                            </div>
                            <div class="feature-title">UDP Scan</div>
                            <div class="feature-description">فحص بروتوكول UDP للخدمات غير TCP</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🎭</div>
                            <div class="feature-title">FIN/NULL/Xmas Scan</div>
                            <div class="feature-description">تقنيات فحص متقدمة لتجاوز جدران الحماية</div>
                        </div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>🌐 المنافذ الحرجة الشائعة</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#00ff88">
                                    <circle cx="12" cy="12" r="10" stroke="#00ff88" stroke-width="2" fill="none"/>
                                    <path d="M8 12h8M12 8c2.21 0 4 1.79 4 4s-1.79 4-4 4M12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4" stroke="#00ff88" stroke-width="1.5" fill="none"/>
                                    <path d="M2 12h4M18 12h4" stroke="#00ff88" stroke-width="1.5"/>
                                </svg>
                            </div>
                            <div class="feature-title">HTTP/HTTPS</div>
                            <div class="feature-description">
                                <strong>المنافذ 80, 443:</strong><br />
                                خدمات الويب، التحقق من SSL/TLS، اكتشاف التطبيقات المكشوفة
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔐</div>
                            <div class="feature-title">SSH/Telnet</div>
                            <div class="feature-description">
                                <strong>المنافذ 22, 23:</strong><br />
                                الوصول البعيد، فحص قوة المصادقة، اكتشاف الوصول غير المصرح
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#6c5ce7">
                                    <ellipse cx="12" cy="5" rx="9" ry="3" fill="#a29bfe"/>
                                    <path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3" stroke="#6c5ce7" stroke-width="2" fill="none"/>
                                    <path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5" stroke="#6c5ce7" stroke-width="2" fill="none"/>
                                    <path d="M3 12v7c0 1.66 4 3 9 3s9-1.34 9-3v-7" stroke="#6c5ce7" stroke-width="2" fill="none"/>
                                </svg>
                            </div>
                            <div class="feature-title">قواعد البيانات</div>
                            <div class="feature-description">
                                <strong>المنافذ 3306, 5432, 1433:</strong><br />
                                MySQL, PostgreSQL, SQL Server - كشف التكوينات غير الآمنة
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                            ...
                            <div class="feature-title">خدمات البريد</div>
                            <div class="feature-description">
                                <strong>المنافذ 25, 110, 143:</strong><br />
                                SMTP, POP3, IMAP - فحص أمان خوادم البريد
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="explanation-section">
                    <h4>🎯 استخدامات الأمان السيبراني</h4>
                    <ul>
                        <li><strong>تقييم الأمان الشبكي:</strong> اكتشاف نقاط الضعف في البنية التحتية</li>
                        <li><strong>اختبار الاختراق:</strong> محاكاة هجمات المخترقين لتحديد الثغرات</li>
                        <li><strong>مراقبة الشبكة:</strong> رصد الخدمات غير المصرحة والتغييرات</li>
                        <li><strong>التحقق من الامتثال:</strong> ضمان اتباع سياسات الأمان</li>
                        <li><strong>الطب الشرعي الشبكي:</strong> تحليل الأنشطة المشبوهة</li>
                        <li><strong>إدارة الأصول:</strong> جرد الخدمات والتطبيقات النشطة</li>
                        <li><strong>تقييم المخاطر:</strong> تحديد أولويات التحصين الأمني</li>
                    </ul>
                </div>
                
                <div class="explanation-section">
                    <h4>📊 حالات المنافذ وتفسيرها</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">
                            ...
                            <div class="feature-title">مفتوح (Open)</div>
                            <div class="feature-description">المنفذ يقبل الاتصالات - قد يكون نقطة دخول</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24">
                            ...
                            <div class="feature-title">مغلق (Closed)</div>
                            <div class="feature-description">المنفذ يرفض الاتصالات - آمن نسبياً</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24">
                            ...
                            <div class="feature-title">مفلتر (Filtered)</div>
                            <div class="feature-description">جدار حماية يحجب الوصول للمنفذ</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24">
                                    <circle cx="12" cy="12" r="10" fill="#ff6348"/>
                                    <path d="M12 8v4l3 3" stroke="white" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>
                            <div class="feature-title">غير مفلتر (Unfiltered)</div>
                            <div class="feature-description">المنفذ قابل للوصول لكن الحالة غير محددة</div>
                        </div>
                    </div>
                </div>
                
                <div class="warning-section">
                    <h4>⚠️ اعتبارات قانونية وأخلاقية</h4>
                    <p>فحص المنافذ يجب أن يتم فقط على الأنظمة التي تملكها أو لديك إذن صريح لفحصها. الفحص غير المصرح به قد يعتبر نشاطاً إجرامياً في العديد من القوانين. استخدم هذه الأداة للأغراض التعليمية والدفاعية فقط.</p>
                </div>
                
                <div class="usage-examples">
                    <h5>🔬 سيناريوهات عملية للفحص:</h5>
                    <div class="code-example">
🖥️ فحص خادم ويب محلي:
...
نتائج الفحص:
🟢 Port 22 (SSH): Open - خدمة الوصول البعيد نشطة
🟢 Port 80 (HTTP): Open - خادم ويب يعمل  
🟢 Port 443 (HTTPS): Open - اتصال آمن متاح
🔴 Port 21 (FTP): Closed - خدمة نقل الملفات معطلة
🟡 Port 23 (Telnet): Filtered - محجوب بواسطة جدار الحماية

تحليل المخاطر:
⚠️ SSH مفتوح - تأكد من قوة كلمات المرور
✅ HTTPS نشط - التشفير متوفر
🛡️ Telnet محجوب - حماية جيدة من البروتوكولات غير الآمنة

🎯 التوصيات الأمنية:
1. إغلاق المنافذ غير المستخدمة
2. تفعيل مصادقة ثنائية لـ SSH
3. تحديث شهادات SSL بانتظام
4. مراقبة محاولات الاتصال المشبوهة
5. تكوين جدار حماية محدود للمنافذ
                    </div>
                </div>
            `
        },
        urlChecker: {
            title: "فاحص أمان الروابط المتقدم",
            ...
            content: `
                <div class="explanation-section">
                    ...
                    <p>نظام حماية شامل يقوم بتحليل الروابط والمواقع للكشف عن التهديدات السيبرانية المتقدمة بما في ذلك الخداع الإلكتروني، البرمجيات الخبيثة، مواقع التصيد، والشهادات المشكوك فيها لضمان تصفح آمن وحماية المعلومات الحساسة.</p>
                </div>
                
                <div class="tool-metrics">
                    <div class="metric-card">
                        <div class="metric-title">قواعد بيانات التهديدات</div>
                        <div class="metric-value">500M+</div>
                        <div class="metric-description">رابط محفوظ ومحلل</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">سرعة الفحص</div>
                        <div class="metric-value">&lt; 2s</div>
                        <div class="metric-description">تحليل فوري شامل</div>
                    </div>
                    <div class="metric-card">
                        <div class="metric-title">دقة الكشف</div>
                        <div class="metric-value">99.8%</div>
                        <div class="metric-description">معدل اكتشاف متقدم</div>
                    </div>
                </div>
                
                <div class="explanation-section">
                    <h4>🛡️ طبقات الحماية المتعددة</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#ff4757">
                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                    <path d="M20 4h-3l-1-1h-4L11 4H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z" fill="#ff6b7a" opacity="0.7"/>
                                </svg>
                            </div>
                            <div class="feature-title">كشف التصيد (Phishing)</div>
                            <div class="feature-description">تحليل هيكل الصفحة والنطاق لاكتشاف مواقع انتحال الهوية والخداع</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#e74c3c">
                            ...
                            <div class="feature-title">اكتشاف البرمجيات الخبيثة</div>
                            <div class="feature-description">فحص الكود والملفات المضمنة للكشف عن الفيروسات وأحصنة طروادة</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#00ff88">
                                    <path d="M18 10V8c0-3.31-2.69-6-6-6S6 4.69 6 8v2H4c-1.1 0-2 .9-2 2v8c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2v-8c0-1.1-.9-2-2-2h-2zM8 8c0-2.21 1.79-4 4-4s4 1.79 4 4v2H8V8zm4 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z"/>
                                </svg>
                            </div>
                            <div class="feature-title">فحص شهادات SSL</div>
                            <div class="feature-description">التحقق من صحة وانتهاء شهادات التشفير والتوقيعات الرقمية</div>
                        </div>  </svg>
                            </div>
                            <div class="feature-title">فحص شهادات SSL</div>
                            <div class="feature-description">التحقق من صحة وانتهاء شهادات التشفير والتوقيعات الرقمية</div>
                        ...
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#3742fa">
                                    <path d="M22 21v-2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v2h20zM6 10v7h4v-7H6zM14 4v13h4V4h-4z"/>
                                    <rect x="6" y="10" width="4" height="7" fill="#5352ed"/>
                                    <rect x="14" y="4" width="4" height="13" fill="#3742fa"/>
                                </svg>
                            </div>
                            <div class="feature-title">تحليل السمعة</div>
                            <div class="feature-description">تقييم تاريخ النطاق والتصنيفات من مصادر الأمان العالمية</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="explanation-section">
                    ...
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#ff4757">
                                    <rect x="2" y="6" width="20" height="12" rx="2" ry="2" fill="#ff6b7a"/>
                                    <rect x="2" y="10" width="20" height="4" fill="#ff4757"/>
                                    <circle cx="18" cy="14" r="1" fill="white"/>
                                </svg>
                            </div>
                            <div class="feature-title">سرقة البيانات المالية</div>
                            <div class="feature-description">
                                مواقع مزيفة تحاكي البنوك وشركات بطاقات الائتمان لسرقة المعلومات المالية
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#e67e22">
                                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/>
                                    <circle cx="8" cy="8" r="1.5" fill="#f39c12"/>
                                    <circle cx="16" cy="8" r="1.5" fill="#f39c12"/>
                                </svg>
                            </div>
                            <div class="feature-title">انتحال المواقع الشهيرة</div>
                            <div class="feature-description">
                                صفحات مقلدة لمواقع Google، Facebook، Microsoft لسرقة بيانات الدخول
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">📧</div>
                            <div class="feature-title">هجمات الهندسة الاجتماعية</div>
                            <div class="feature-description">
                                مواقع تستخدم التلاعب النفسي لخداع المستخدمين وسرقة معلوماتهم
                            </div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24" fill="#f1c40f">
                                    ...
                                    <path d="M12 6v2M12 16v2M8.5 9a3.5 3.5 0 0 1 7 0M8.5 15a3.5 3.5 0 0 1 7 0" stroke="white" stroke-width="1" fill="none"/>
                                </svg>
                            </div>
                            <div class="feature-title">عمليات الاحتيال المالي</div>
                            <div class="feature-description">
                                مخططات الثراء السريع والاستثمارات الوهمية وعمليات النصب المالي
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="explanation-section">
                    <h4>🔍 معايير التحليل التقني</h4>
                    <ul>
                        <li><strong>تحليل النطاق (Domain Analysis):</strong> فحص عمر النطاق، تاريخ التسجيل، معلومات المالك</li>
                        <li><strong>فحص الشهادات الرقمية:</strong> التحقق من صحة SSL/TLS وسلطات التوثيق</li>
                        <li><strong>تحليل المحتوى:</strong> فحص الكود المصدري للصفحة والبحث عن العناصر المشبوهة</li>
                        <li><strong>قوائم السمعة العالمية:</strong> مقارنة مع قواعد بيانات التهديدات المعروفة</li>
                        <li><strong>كشف تقنيات الإخفاء:</strong> اكتشاف URL Shorteners وتقنيات التمويه</li>
                        <li><strong>تحليل السلوك:</strong> مراقبة أنماط التوجيه والإعادات المشبوهة</li>
                        <li><strong>فحص الموارد المضمنة:</strong> تحليل الصور والسكريبتات والملفات المرفقة</li>
                    </ul>
                </div>
                
                <div class="explanation-section">
                    <h4>📈 مؤشرات الأمان المتقدمة</h4>
                    <div class="feature-grid">
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24">
                            ...
                            <div class="feature-title">آمن (Safe)</div>
                            <div class="feature-description">شهادات صحيحة، سمعة جيدة، لا توجد تهديدات معروفة</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24">
                            ...
                            <div class="feature-title">مشكوك فيه (Suspicious)</div>
                            <div class="feature-description">مؤشرات تحذيرية، يحتاج حذر إضافي</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24">
                                    <circle cx="12" cy="12" r="10" fill="#ff6348"/>
                                    <path d="M12 8v8M8 12l8 0" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <div class="feature-item">
                            <div class="feature-icon">
                                <svg viewBox="0 0 24 24" width="24" height="24">
                                    <circle cx="12" cy="12" r="10" fill="#ff4757"/>
                            ...
                            <div class="feature-title">خبيث (Malicious)</div>
                            <div class="feature-description">تهديدات محتملة، تجنب الزيارة</div>
                        </div>
                        <div class="feature-item">
                            <div class="feature-icon">🔴</div>
                            <div class="feature-title">خبيث (Malicious)</div>
                            <div class="feature-description">تهديد مؤكد، خطر على الأمان</div>
                        </div>
                    </div>
                </div>
                
                <div class="warning-section">
                    <h4>🚨 علامات التحذير الحرجة</h4>
                    <p>تجنب المواقع التي تطلب معلومات حساسة دون تشفير HTTPS، أو التي تحتوي على أخطاء إملائية في عناوين المواقع المشهورة، أو التي تعرض نوافذ منبثقة مشبوهة. كن حذراً بشكل خاص من الروابط الواردة عبر البريد الإلكتروني أو الرسائل النصية غير المتوقعة.</p>
                </div>
                
                <div class="usage-examples">
                    <h5>🔬 أمثلة عملية على التحليل:</h5>
                    <div class="code-example">
🌐 فحص رابط مشبوه:
URL: https://secure-bank-login.suspicious-domain.com

نتائج التحليل الشامل:
❌ تحذير: اسم النطاق مشبوه (يحاكي بنك مشهور)
❌ شهادة SSL: منتهية الصلاحية منذ 30 يوم
❌ عمر النطاق: مسجل منذ 3 أيام فقط
❌ قائمة سوداء: مدرج في 5 قوائم تهديدات
❌ تحليل المحتوى: يحتوي على نماذج سرقة بيانات

📊 تقييم الخطر: 95% (خطر عالي جداً)
🚨 التوصية: عدم زيارة الموقع نهائياً

✅ مثال على موقع آمن:
URL: https://www.paypal.com

نتائج التحليل:
✅ شهادة SSL: صحيحة وسارية (EV Certificate)
✅ عمر النطاق: مسجل منذ 25 سنة
✅ السمعة: ممتازة في جميع قواعد البيانات
✅ HTTPS: تشفير قوي AES-256
✅ تحليل المحتوى: لا توجد تهديدات

📊 تقييم الأمان: 98% (آمن جداً)
🎯 التوصية: آمن للاستخدام

🛡️ نصائح الحماية:
• تحقق دائماً من صحة عنوان الموقع
• ابحث عن قفل الأمان في المتصفح
• كن حذراً من الروابط المختصرة
• لا تدخل معلومات حساسة في مواقع مشبوهة
...
// Platform Info Modal Functions - Professional Enhancement
function showPlatformInfo() {
    try {
        const modal = document.getElementById('platformInfoModal');
        if (modal) {
            // Add show class with professional animation
            modal.style.display = 'block';
            setTimeout(() => {
                modal.classList.add('show');
            }, 10);
            
            // Add professional fade-in animation for sections
            ...
            document.addEventListener('keydown', handlePlatformModalKeydown);
        }
    } catch (e) {
...
function closePlatformInfo() {
    try {
        ...
        if (modal) {
            ...
            document.removeEventListener('keydown', handlePlatformModalKeydown);
        }
    } catch (e) {
...
// Keyboard navigation for platform modal
function handlePlatformModalKeydown(event) {
    if (event.key === 'Escape') {
        closePlatformInfo();
    }
}
